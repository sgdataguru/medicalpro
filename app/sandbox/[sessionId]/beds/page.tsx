...
export default function SandboxBedsPage() {
  ...
  useEffect(() => {
    dispatch({
      ...
      payload: { feature: 'bedAllocation', status: 'visited' },
    });
  }, [dispatch]);

  const kpis = [
    { label: 'Beds Occupied', value: '487/500', icon: 'bed' },
    { label: 'Occupancy Rate', value: '97.4%', icon: 'percent' },
    { label: 'Avg Stay', value: '4.2 days', icon: 'calendar_today' },
    { label: 'Pending Discharge', value: '23', icon: 'exit_to_app' },
  ];
      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ backgroundColor: '#2170e420' }}
          >
            <span className="material-symbols-outlined text-[28px]" style={{ color: '#2170e4' }}>
              bed
            </span>
          </div>
          <div>
            <h1 className="font-headline text-2xl font-bold text-white">Bed Allocation</h1>
            <p className="text-sm text-white/50">Ward occupancy and capacity management</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="flex h-64 items-center justify-center rounded-lg border border-dashed border-white/10">
            <div className="text-center text-white/30">
              <span className="material-symbols-outlined mb-2 text-[48px]">stacked_bar_chart</span>
