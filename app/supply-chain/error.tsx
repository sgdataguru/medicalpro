...
export default function SupplyChainError({
  ...
  useEffect(() => {
    console.error('[SupplyChain] Unhandled error:', error);
  }, [error]);
    ...
    <div className="flex min-h-screen items-center justify-center bg-surface px-4">
      <div className="w-full max-w-lg text-center">
        ...
        <p className="mx-auto mb-2 max-w-md text-base leading-relaxed text-on-surface-variant">
          The Supply Chain module encountered an unexpected error. Inventory
          data and procurement records remain safe — this is a display-level
          issue only.
        </p>
