...
export default function BedAllocationError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[BedAllocation] Unhandled error:', error);
  }, [error]);
    ...
    <div className="flex min-h-screen items-center justify-center bg-surface px-4">
      <div className="w-full max-w-lg text-center">
        ...
        <p className="mx-auto mb-2 max-w-md text-base leading-relaxed text-on-surface-variant">
          The Bed Allocation module encountered an unexpected error. Patient
          data and allocation records remain safe — this is a display-level
          issue only.
        </p>
