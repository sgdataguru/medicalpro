...
export default function RevenueCostError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[RevenueCost] Unhandled error:', error);
  }, [error]);
    ...
    <div className="flex min-h-screen items-center justify-center bg-surface px-4">
      <div className="w-full max-w-lg text-center">
        ...
        <p className="mx-auto mb-2 max-w-md text-base leading-relaxed text-on-surface-variant">
          The Revenue &amp; Cost Analysis module encountered an unexpected
          error. Financial data and records remain safe — this is a
